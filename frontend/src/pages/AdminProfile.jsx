      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-6">
            <Link to="/admin-dashboard" className="text-gray-600 hover:text-orange-500 font-medium transition-colors">
              Dashboard
            </Link>
            <Link to="/admin-profile" className="text-orange-500 font-medium">
              Profile
            </Link>
            <button
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-6 bg-orange-50 rounded-xl">
                    ...
                    <p className="text-gray-600">{user.isVerified ? 'Yes' : 'No'}</p>
                  </div>
                  <div className="p-6 bg-orange-50 rounded-xl">
                    <h3 className="font-semibold text-gray-900 mb-2 flex items-center space-x-2">
                      <span>📅</span>
                ...
                <div className="mt-8 p-6 bg-red-50 rounded-xl border-2 border-red-200">
                  <h3 className="font-semibold text-red-900 mb-2 text-lg">⚠️ Danger Zone</h3>
